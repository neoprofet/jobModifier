...
public class ExternalCodeFabric {
    ...
    public static String getNewCodeToInsertToLogconfig() {
        return "try {\n" +
    ...
    public static String getNewCodeToInsertToTJavaRowStatus() {
        return "JSONObject response = new JSONObject();\n" +
